...
namespace BuildingTools
{
    public class BuildingToolsPlugin : GamePlugin
    {
        ...
        public static GlobalKeyListener Listener { get; private set; }
        ...
        public void OnLoad()
        {
            ...
            KeyPressEvent searchEvent = new KeyPressEvent(() =>
                 Input.GetKeyDown(KeyCode.BackQuote) && cBuild.GetSingleton().buildMode != enumBuildMode.inactive
            );
            GlobalKeyListener.Events.Add(searchEvent);
            searchEvent.KeyPressed += () => searchUI.ToggleGui();
        }
